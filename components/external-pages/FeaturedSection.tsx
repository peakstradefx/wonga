                ...
                <div
                    ...
                    <div className="relative w-full text-center max-md:max-w-sm max-md:mx-auto group md:w-2/5 lg:w-1/4">
                        ...
                        <h4 className="text-lg font-semibold text-gray-900 mb-3 capitalize">
                            Regulated Mining Broker
                        </h4>
                        <p className="text-sm font-normal text-gray-500">
                            Regulated under the strict standards of the MFSA in US, P24O Ltd. complies with the highest regulatory standards
                        </p>
                    </div>
                    <div className="relative w-full text-center max-md:max-w-sm max-md:mx-auto group md:w-2/5 lg:w-1/4">
                        ...
                        <p className="text-sm font-normal text-gray-500">
                            Trade Peak FX Company Platform never stands still, continually innovating to make the trading experience seamless, intuitive and user-friendly.
                        </p>
                    </div>
                    <div className="relative w-full text-center max-md:max-w-sm max-md:mx-auto group md:w-2/5 lg:w-1/4">
                    ...
                    <div className="relative w-full text-center max-md:max-w-sm max-md:mx-auto group md:w-2/5 lg:w-1/4">
                        ...
                        <p className="text-sm font-normal text-gray-500">
                            Trade Peak FX Company Platform Electronic Communication Network technology, which seeks to guarantee that traders always trade under the best trading conditions.
                        </p>
                    </div>
                </div>
            </div>
