import ContactUsForm from '@/components/external-pages/ContactUsForm'
                        ...
                        <div className="lg:mb-0 mb-10">
                            <div className="group w-full h-full">
                                <div className="relative h-full">
                                    <Image src="https://pagedone.io/asset/uploads/1696488602.png" alt="ContactUs tailwind section" className="w-full h-full lg:rounded-l-2xl rounded-2xl bg-blend-multiply bg-indigo-700 object-cover" width={2000} height={3000} />
                                    ...
                                    <div className="absolute bottom-0 w-full lg:p-11 p-5">
                                        <div className="bg-white rounded-lg p-6 block">
                                            <Link href="javascript:;" className="flex items-center mb-6">
                                                ...
                                                <h5 className="text-black text-base font-normal leading-6 ml-5">+1 909 577 2165 </h5>
                                            </Link>
                                            <Link href="javascript:;" className="flex items-center mb-6">
                                                <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <h5 className="text-black text-base font-normal leading-6 ml-5">support@peakstradefx.com</h5>
                                            </Link>
                                            <Link href="javascript:;" className="flex items-center">
                                                ...
                                                <h5 className="text-black text-base font-normal leading-6 ml-5">115 Circle Club Ln Georgetown TX 78633</h5>
                                            </Link>
                                        </div>
                                    </div>
                                </div>
